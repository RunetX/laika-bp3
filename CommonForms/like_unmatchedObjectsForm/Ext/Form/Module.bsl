...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	measureUnits.Load(	GetUnmatchedItemsByType(unmatchedObjects, Type("CatalogRef.КлассификаторЕдиницИзмерения")));
	products.Load(		GetUnmatchedItemsByType(unmatchedObjects, Type("CatalogRef.Номенклатура")));
...
Procedure SaveValuesAtServer()
	...
	If matchingType = "Поступление" Then
